...
{
    //collection for the different features
    public HexFeatureCollection[] urbanCollections, plantCollections, farmCollections;
    ...
    //contains the features, gets deleted to fast manage replant of a feature
    Transform container;
